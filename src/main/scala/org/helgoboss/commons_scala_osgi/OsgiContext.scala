...
import org.helgoboss.module_support.{ModuleContext, ModuleContainer}
 ...
 */
trait OsgiContext extends EmptyBundleActivator with ModuleContext {
    ...
    protected def whenBundleActive(f: => Unit) {
